...
➡️ **[Get the latest version](https://github.com/fuchcar/arcane-rostrum-releases/releases/latest)**
...
- **Cast** — Build PCs, NPCs, and monsters. Add a character fast (one field at a time)
  ...
  Full stat blocks with auto-derived HP/AC/to-hit/save math, plus a 100+ creature
  bestiary to pull from.
...
- **Battle map** — A proper tactical map editor: draw walls / rooms / doors, paint
  ...
  **Generate** for an instant dungeon, cave, forest, or town. Dynamic lighting with
  ...
  screen, and you can run the actual fight on it — move tokens, aim attacks, preview
  areas of effect.
...
- **Combat tracker** — Initiative order, HP with an undo-able damage log, conditions,
  ...
  — roll to-hit vs AC, crits, damage — with re-roll and *confirm-before-it-logs* so you
  stay in control. One tap of **combat focus** hides everything but the fight.
...
- **Find anything (Ctrl-K)** — A quick-launcher to jump to any tab, character, or clue —
  or create things — without hunting through menus.
...
auto-saves to a real file on your machine. Updates download from this page automatically.
